...
export default function Login() {
    ...
    return (
        <form onSubmit={hasAccount ? handleLogin : handleSignUp} className="mt-28 rounded-md max-w-sm mx-auto bg-gray-800 p-16 ">
            ...
            <div className="w-full pt-4">
                <div className="grid max-w-xs grid-cols-2 gap-1 p-1 mx-auto my-2 bg-gray-100 rounded-lg dark:bg-gray-600" role="group">
                    <button onClick={() => setHasAccount(true)} type="button" className={`px-5 py-1.5 text-xs font-medium ${hasAccount ? "text-white bg-gray-900 dark:bg-gray-300 dark:text-gray-900" : " text-gray-900 hover:bg-gray-200 dark:text-white dark:hover:bg-gray-700"} rounded-lg`}>
                        Login
                    </button>
                    <button onClick={() => setHasAccount(false)} type="button" className={`px-5 py-1.5 text-xs font-medium ${hasAccount ? " text-gray-900 hover:bg-gray-200 dark:text-white dark:hover:bg-gray-700" : "text-white bg-gray-900 dark:bg-gray-300 dark:text-gray-900"} rounded-lg`}>
                        Cadastro
                    </button>
                </div>
            </div>
            ...
            <div className="relative ">
                ...
                <input onChange={(e) => {setEmail(e.target.value)}} type="text" id="email-address-icon" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="nome@gmail.com"/>
            </div>
            ...
            <div className="relative flex flex-row">
                ...
                <input 
                    ...
                    placeholder="Senha"
                />
                <button type="button" className="absolute inset-y-0 end-4 flex items-center ps-3.5" onClick={() => toggleVisibility('confirm')}>
                    {passwordVis ? 
            ...
            <div className="flex justify-center pt-4">
                <button type="submit" className="inline-block px-6 py-2.5 text-xs font-medium text-white uppercase bg-blue-600 rounded-md hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
